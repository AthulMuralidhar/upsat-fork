...
/** @defgroup USBD_DESC_Private_Defines
  ...
  */ 
//vendor id
#define USBD_VID                        0x0483 //0x304
//product id
#define USBD_PID                        0x7540 //0xe457

/** @defgroup USB_String_Descriptors
  * @{
  */ 
#define USBD_LANGID_STRING              0x40b
#define USBD_MANUFACTURER_STRING        "University Of Patras"

#define USBD_PRODUCT_HS_STRING          "ATLANTAS HS"
#define USBD_SERIALNUMBER_HS_STRING     "00000000050B"

#define USBD_PRODUCT_FS_STRING          "ATLANTAS FS"
